    ...
    karma: {
      options: {
        ...
        files: [
          ...
          '<%= yeoman.app %>/scripts/login-provider.js',
          '<%= yeoman.app %>/scripts/translations.js',
          '<%= yeoman.app %>/scripts/controllers.js',
          '<%= yeoman.app %>/scripts/controllers/dashboard/dashboard-controller.js',
          '<%= yeoman.app %>/scripts/controllers/site/site-controller.js',
          '<%= yeoman.app %>/scripts/controllers/login/login-controller.js',
          '<%= yeoman.app %>/scripts/controllers/tree/tree-controller.js',
          '<%= yeoman.app %>/scripts/controllers/neuron/neuron-controller.js',
          '<%= yeoman.app %>/scripts/controllers/content/content-controller.js',
          '<%= yeoman.app %>/scripts/services.js',
          '<%= yeoman.app %>/scripts/services/neuron-service.js',
          '<%= yeoman.app %>/scripts/services/tree-service.js',
          '<%= yeoman.app %>/scripts/services/content-service.js',
          '<%= yeoman.app %>/scripts/directives.js',
          '<%= yeoman.app %>/scripts/directives/grid-contents/grid-contents.js',
          '<%= yeoman.app %>/scripts/directives/gif-no-loop/gif-no-loop.js',
          '<%= yeoman.app %>/scripts/directives/gif-queue/gif-queue.js',
          '<%= yeoman.app %>/scripts/directives/moi-sound/moi-sound.js',
          '<%= yeoman.app %>/scripts/directives/back-button/back-button.js',
