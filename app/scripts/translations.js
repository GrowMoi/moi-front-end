  ...
  .config(function ($translateProvider) {
    ...
    $translateProvider.translations('en', {
      ...
      modal_certificate:{
        ...
        progress: ' Mi Aula BdP tree development',
        test: ' Final test score',
        tiempo: ' Average read time',
        informacion: ' For more, visit miaulabdp.com',
      ...
      terms:{
        tittleTerms: 'Términos de Servicio Mi Aula BdP',
        introDescription: 'Al acceder, usar o registrarse en cualquier sitio o servicio puesto a disposición por Mi Aula BdP,'+
            ' o al descargar cualquiera de las aplicaciones móviles de Mi Aula BdP (conjuntamente, los “Materiales”), usted reconoce que (i) ha leído y acordado obligarse por los presentes términos de servicio'+
            ...
            'Mi Aula BdP pretende ser utilizado por estudiantes, profesores e instituciones educacionales, públicas o privadas.'+
            'Prestamos nuestros servicios a profesores, y Mi Aula BdP está disponible para niños desde los 6 años de edad.'+
            'Fuera de Ecuador, si eres menor de edad en el país de tu residencia, debes revisar este Acuerdo con tus padres o tutores para asegurarte que tú y tus padres o tutores lo entienden.'+
            'Te notificaremos de cualquier actualización a estos Términos de Servicio al publicarla en Mi Aula BdP y por correo electrónico dirigido a la dirección de correo en tu cuenta.'+
            ...
            'Los Materiales podrán contener material de nuestra propiedad o que nos fue licenciada. Este material incluye, pero no está limitado a, diseño, layout, look, apariencia, y gráficas. La reproducción de este contenido fuera de Mi Aula BdP está prohibida.'+
            'Mi Aula BdP es dueña de todo derecho, título e interés en los Materiales, incluyendo todo derecho de propiedad, ya sea que esté registrado o no,  y donde sea que dichos derechos existan.'+
        ...
        contentUserDescription: 'Algunas áreas de los Materiales facultarán a los usuarios a publicar contenidos tales como notas, resultados y comentarios, o cualquier otro contenido o información (cualquier material que un usuario ingrese, publique, presente, o ponga a disposición en los Materiales o sitio se considerará “Contenido de Usuario”).'+
            'Usted mantendrá propiedad sobre su Contenido de Usuario. Bajo ninguna circunstancia Mi Aula BdP será responsable por el pago del Contenido de Usuario que provea. Usted es el único responsable por el Contenido de Usuario que haga disponible a través de los Materiales. Mi Aula BdP no controla el Contenido de Usuario que se almacena  través del servicio,' +
            ...
            'Para los fines de estos términos de servicio, “Derechos de Propiedad Intelectual” significa todos los derechos de patente, copyrights, derechos sobre los esquemas de trazado de circuitos integrados, derechos morales, derechos de publicidad, marcas comerciales, marcas de fábrica, marcas de servicios, secretos profesionales y cualquier otro derecho de propiedad intelectual que exista actualmente'+
            ...
            'A. Su Contenido de Usuario y el uso del mismo por parte de Mi Aula BdP según lo contemplado por estos términos de servicio y los Materiales no infringen ninguna ley o derechos de terceros, '+
            'incluyendo pero no limitándose a cualquier Derecho de Propiedad Intelectual o de privacidad.'+
            'B. A su mejor saber y entender, todo su Contenido de Usuario y cualquier otra información que nos provea es verdadera y precisa.'+
            'Mi Aula BdP no se hará responsable ni asumirá perjuicio alguno por cualquier Contenido de Usuario que usted o cualquier otro usuario o tercero publique o envíe a través de los Servicios.'+
            ...
            'Usted entiende y acuerda que podrá estar expuesto a Contenido de Usuario que sea impreciso, objetable, inapropiado para niños, o de otra manera inapropiado para su propósito, y acuerda que Mi Aula BdP no será responsable por cualquier perjuicio que pueda sufrir como resultado de Contenido de Usuario. '+
            'Al publicar cualquier Contenido de Usuario en los Materiales o sitio, usted expresamente otorga, y representa y garantiza que tiene derecho a otorgar, a Mi Aula BdP una licencia gratuita, sublicenciable, transferible, perpetua, irrevocable, no-exclusiva, mundial para usar, reproducir, modificar, publicar, '+
            ...
            ' y hacer cumplir nuestros acuerdos. Consistente con estos requerimientos, trataremos de borrar su Contenido de Usuario tan rápido como sea posible una vez fuese solicitado. Rogamos tener presente que, de todas formas, podrá haber una demora en la supresión del Contenido de Usuario de nuestros servidores y que versiones de respaldo podrán existir después del borrado. Adicionalmente, no borramos Contenido de Usuario de nuestros servidores que tengan en común con otros usuarios',
        ...
        integrityDescription:'Usted es responsable de mantener la confidencialidad de las contraseñas asociadas con cualquier cuenta que usted utilice para acceder a los Materiales y será responsable de todas las actividades que ocurran bajo sus cuentas. Usted es exclusivamente responsable por toda consequencia,'+
            'pérdida, o daño que nosotros directa o indirectamente suframos debido al uso no autorizado realizado por su cuenta. Mi Aula BdP no será responsable de los perjuicios que sufra por la utilización de su cuenta por parte de terceros. Usted será responsable por los perjuicios que sufra Mi Aula BdP por el uso de su cuenta por parte de terceros.',
        ...
        lawDescription: 'Podremos, sin notificación previa, suspender o poner término al acceso de los Materiales, o a ciertas características de los mismos, o crear límites a su acceso.'+
          ...
          'de la cuenta que permanezca en los servidores podrá ser borrado, alterado, movido o transferido en cualquier momento por cualquier razón a sola decisión de Mi Aula BdP, con o sin notificación previa y sin responsabilidad alguna. Mi Aula BdP no provee o garantiza, y expresamente niega, cualquier valor que se le pueda atribuir a los datos que permanezcan en los servidores que contienen los Materiales.',
        license: 'Mi Aula BdP le otorga una licencia limitada',
        licenseDescription: 'Sujeto al cumplimiento de los términos y condiciones de estos términos de servicio, se le otorga una licencia no-exclusiva, limitada, intransferible, libremente revocable para acceder a los Materiales como fueron diseñados.'+
          'Mi Aula BdP se reserva todos los derechos no expresamente otorgados en los Materiales. Mi Aula BdP podrá terminar esta licencia en cualquier momento por cualquier razón o sin razón alguna.',
        information: 'Usted nos provee su información a su propio riesgo y consciente en que esta sea procesada en servidores en Estados Unidos',
        informationDescription: 'Nos preocupa la privacidad de nuestros Usuarios. Hemos implementado medidas técnicas y organizacionales comercialmente razonables para asegurar su información personal de pérdida accidental o de acceso no autorizado, uso, alteración o divulgación. De todas formas, no podemos garantizar que terceros no autorizados nunca serán capaces de derrotar estas medidas o usar su información personal propósitos impropios. Usted acuerda entregar su información personal o toda otra información a Mi Aula BdP a su propio riesgo. Usted acuerda que su información personal sea recopilada, usada, transferida y procesada en servidores en Estados Unidos.'+
          'Nos reservamos el derecho de rastrear y reportar de forma anónima la actividad de los usuarios en los Materiales usando información que no permite la identificación personal de los usuarios. No publicitaremos ni comerciaremos a estudiantes, ni compartiremos la información de los estudiantes recolectada por Mi Aula BdP con terceros para fines de publicidad o marketing.',
        materials:'Materiales de terceros',
        materialsDescription: 'Los Materiales podrán contener enlaces a contenidos, sitios web, juegos y/o presentaciones de terceros que no son de propiedad o controladas por Mi Aula BdP. Mi Aula BdP no avala o asume responsabilidad alguna por cualquier de los sitios, informaciones, y contenidos de terceros. Si accede a un sitio web de terceros desde los Materiales o sitio, usted lo hace a su propio riesgo, y entiende que estos términos de servicios no aplicarán en la utilización de dichos sitios. Usted expresamente libera a Mi Aula BdP de toda responsabilidad que pueda originarse en la utilización de cualquier sitio web, información,'+
          'o contenido de terceros. Usted acuerda que Mi Aula BdP no será responsable por la pérdida o daño de cualquier tipo relacionado a sus transacciones con tales anunciantes.',
        indemnify: 'USTED NOS INDEMNIZARÁ',
        indemnifyDescription: 'Usted acuerda defender, indemnizar y eximir a Mi Aula BdP y sus agentes, licenciantes, administradores, y otras compañías afiliadas, y sus empleados, contratistas, agentes, representantes y directores, de toda responsabilidad y/o denuncia, daño, obligación, pérdida, costo o deuda,'+
          ...
          'norma o regulación de Ecuador o cualquier otro país; (v) cualquier denuncia o daño que surja como resultado de su Contenido de Usuario o cualquier otro que sea ingresado a través de su cuenta; o (vi) cualquier acceso y uso de los Materiales por parte de terceros con su nombre de usuario único, contraseña u otro código de seguridad apropiado.',
        ...
        noGuaranteDescription: 'LOS MATERIALES SON OFRECIDOS TAL COMO SON Y SEGÚN DISPONIBILIDAD. EL USO DE LOS MATERIALES ES A SU PROPIO RIESGO. A LA MÁXIMA EXTENSIÓN PERMITIDA POR LA LEY, LOS MATERIALES SON OFRECIDOS SIN GARANTÍA DE NINGÚN TIPO, YA SEA EXPRESA O IMPLÍCITA, INCLUYENDO, PERO NO LIMITADO A, GARANTÍAS IMPLÍCITAS DE COMERCIABILIDAD,'+
          'ADECUACIÓN A UN PROPÓSITO PARTICULAR, O NO INFRACCIÓN. NINGÚN CONSEJO O INFORMACIÓN, YA SEA ORAL O ESCRITO, OBTENIDO POR USTED DE Mi Aula BdP O A TRAVÉS DE LOS MATERIALES ORIGINARÁ GARANTÍA ALGUNA QUE NO SE ENCUENTRE ESTABLECIDA EXPRESAMENTE EN ESTOS TÉRMINOS. SIN LIMITACIÓN DE NINGÚN TIPO, MI AULA BDP Y SUS LICENCIANTES NO GARANTIZAN QUE EL CONTENIDO ES PRECISO, CONFIABLE O CORRECTO; QUE LOS MATERIALES SATISFACERAN SUS REQUERIMIENTOS; QUE LOS MATERIALES'+
        ...
        limitationDescription: 'A LA MÁXIMA EXTENSIÓN PERMITIDA POR LA LEY, EN NINGÚN EVENTO SERÁ MI AULA BDP, SUS AFILIADOS, AGENTES, DIRECTORES, EMPLEADOS, PROVEEDORES O LICENCIANTES RESPONSABLE(S) POR CUALQUIER DAÑO DIRECTO, INDIRECTO, PUNITIVO, INCIDENTAL, ESPECIAL, CONSECUENTE O EJEMPLAR, INCLUYENDO SIN LIMITACIÓN DAÑOS POR LUCRO CESANTE, BUENA FE, USO, INFORMACIÓN U OTRAS PÉRDIDAS INTANGIBLES, QUE RESULTEN POR EL USO DE, O LA INHABILIDAD DE USAR, ESTOS SERVICIOS. EN NINGUNA CIRCUNSTANCIA SERÁ MI AULA BDP RESPONSABLE POR CUALQUIER DAÑO, PÉRDIDA O LESIÓN RESULTANTE DE LA PIRATERÍA, ALTERACIÓN DE DATOS Y OTRO ACCESO NO AUTORIZADO O USO DE LOS MATERIALES O SU CUENTA O LA INFORMACIÓN CONTENIDA EN ELLA.'+
          'A LA MÁXIMA EXTENSIÓN PERMITIDA POR LA LEY, Mi Aula BdP NO ASUME RESPONSABILIDAD ALGUNA POR (I) CUALQUIER ERROR, EQUIVOCACIÓN, OMISIÓN O INEXACTITUD DEL CONTENIDO; (II) CUALQUIER LESIÓN PERSONAL O DAÑO A LA PROPIEDAD, DE NINGUNA NATURALEZA, RESULTANTE DE SU ACCESO A O USO DE NUESTROS MATERIALES; (III) CUALQUIER ACCESO O USO NO AUTORIZADO DE NUESTROS SERVIDORES  DE SEGURIDAD Y/O CUALQUIER INFORMACIÓN PERSONAL ALMACENADO EN ELLOS; (IV) CUALQUIER INTERRUPCIÓN O CESE DE TRANSMISIÓN A O DE LOS MATERIALES; (V) CUALQUIER BUG, VIRUS, TROYANOS, O SIMILARES QUE PUEDA SER TRANSMITIDO A O POR MEDIO DE NUESTROS MATERIALES POR TERCEROS; (VI) CUALQUIER PÉRDIDA O DAÑO INCURRIDO COMO RESULTADO DEL USO DEL CONTENIDO PUBLICADO,'+
          'ENVIADO, TRANSMITIDO, O DE OTRA FORMA PUESTO A DISPOSICIÓN A TRAVÉS DE LOS MATERIALES; Y/O (VII) CUALQUIER CONTENIDO DE USUARIO O DE CONDUCTA DIFAMATORIA, OFENSIVA, O ILEGAL DE CUALQUIER TERCERO. EN NINGÚN EVENTO SERÁ MI AULA BDP, SUS AFILIADOS, AGENTES, DIRECTORES, EMPLEADOS, PROVEEDORES O LICENCIANTES RESPONSABLE(S) ANTE USTED POR CUALQUIER DENUNCIA, PROCEDIMIENTO, RESPONSABILIDAD, OBLIGACIÓN, DAÑO, PÉRDIDA O COSTO EN UN MONTO QUE EXCEDA EL QUE USTED HA PAGADO A MI AULA BDP.'+
          'ESTA LIMITACIÓN DE RESPONSABILIDAD SURTE PLENO EFECTO INDEPENDIENTE SI LA RESPONSABILIDAD ALEGADA SE FUNDAMENTA EN SEDE CONTRACTUAL O EXTRACONTRACTUAL, NEGLIGENCIA, RESPONSABILIDAD ESTRICTA, O BAJO CUALQUIER OTRA BASE, INCLUSO SI MI AULA BDP HA SIDO ASESORADA ACERCA DE LA POSIBILIDAD DE DICHO DAÑO. LA PRESENTE LIMITACIÓN DE RESPONSABILIDAD APLICARÁ A LA MÁXIMA EXTENSIÓN PERMITIDA POR LA LEY ANTE EL TRIBUNAL COMPETENTE.',
        notifications:  'Notificaciones',
        notificationsDescription: 'Mi Aula BdP podrá notificarle, ya sea que tales notificaciones sean requeridas por ley o sean necesarias por otras razones comerciales,  via aviso por e-mail, escrita o en copia de papel, o a través de la publicación de tal aviso en nuestro sitio web, de la forma determinada por Mi Aula BdPa su solo arbitrio. Mi Aula BdP se reserva el derecho a determinar la forma y los medios para notificar a nuestros usuarios. Mi Aula BdP no es responsable por cualquier filtración automática que usted o su proveedor de red puedan aplicar a las notificaciones por e-mail que enviemos a la dirección de correo que nos ha proveído. Recomendamos agregar webadmin@pacifico.fin.ec a su agenda de contactos para así asegurar recibir nuestras notificaciones por e-mail.',
        ...
        blockDescription: 'Este Acuerdo, conjuntamente con cualquier enmienda o acuerdo adicional que suscriba con Mi Aula BdP en conexión con los Materiales, constituirá el acuerdo entero entre usted y Mi Aula BdP respecto de los Materiales. Si cualquier provisión de este Acuerdo se considerara inválida por algún tribunal de competente jurisdicción, la invalidez de dicha provisión no afectará la validez de las demás provisiones de este Acuerdo, que permanecerá totalmente vigente.'+
          'La omisión de exigir el estricto cumplimiento de cualquiera de los términos de estos términos de servicio en una o más ocasiones no podrá ser considerada, en ningún caso, como renuncia de derechos o consentimiento, ni privará a Mi Aula BdP de su facultad de exigir el estricto cumplimiento de las obligaciones que de él derivan.'
      }
    });
    ...
    $translateProvider.translations('es', {
      ...
      modal_end_test : {
        ...
        'content_tree_completed': 'Completaste tu árbol Mi Aula BdP. Responde el test final para recibir tu diploma.',
        'ok': 'OK',
        'cancel': 'Cancelar'
      },
      modal_join : {
      ...
      modal_certificate:{
        ...
        informacion: ' Para más información, visite miaulabdp.com',
