(function () {
  ...
  angular.module('moi')
    .value('AdvicesPage', {
      ...
      friends: {
        messages: [
          'Busca a tus amigos por su nombre. Podrás conocer su árbol y su progreso en Mi Aula BdP.'
        ]
      },
      sidebar: {
        messages: [
          'Edita tus preferencias, revisa tu perfil y tu inventario o si prefieres, vuelve a tu árbol Mi Aula BdP'
        ]
      },
      inventory: {
        messages: [
